...
keymap.set("n", "<leader>tx", ":BufferClose<CR>") -- close a tab
keymap.set("n", "<leader>tn", ":BufferNext<CR>") -- next tab
keymap.set("n", "<leader>tp", ":BufferPrevious<CR>") -- previous tab
keymap.set("n", "<C-t>n", ":BufferMoveNext<CR>") -- move next tab
keymap.set("n", "<C-t>p", ":BufferMovePrevious<CR>") -- move previous tab
keymap.set("n", "<leader>tt", ":BufferPick<CR>") -- pick tab
